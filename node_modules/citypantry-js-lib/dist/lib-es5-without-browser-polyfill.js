...
angular.module("cpLib").factory("CustomersFactory", function (ApiService, getCustomerPersonaTextFilter) {
    return {
        ...
        updatePayOnAccountDetails: function (id, payOnAccountDetails) {
            return ApiService.put("/customer/" + id + "/pay-on-account", payOnAccountDetails);
        },
        ...
        getPersonaOptions: function getPersonaOptions() {
            return [1, 2, 3, 4, 5, 6, 7].map(function (value) {
                return { value: value, label: getCustomerPersonaTextFilter(value) };
            });
        }
    };
});
...
angular.module("cpLib").factory("MealPlanFactory", function (ApiService) {
    return {
        ...
        addCustomerToMealPlan: function (id) {
            return ApiService.put("/meal-plan/customers/" + id);
        },
...
angular.module("cpLib").factory("OrdersFactory", function (ApiService, getDeliveryStatusTextFilter) {
    ...
    return {
        ...
        getOrdersWithMessages: function () {
            return ApiService.get("/orders/with-messages");
        },
        ...
        setDeliveryStatus: function (id, statusDetails) {
            return ApiService.put("/order/" + id + "/delivery-status", statusDetails);
        },
        ...
        getDeliveryStatusOptions: function () {
            return [1, 2, 3, 4].map(function (value) {
                return { value: value, label: getDeliveryStatusTextFilter(value) };
            });
        },

        createOrdersCsvFile: function (orderIds) {
            return ApiService.post("/orders/create-csv", { orderIds: orderIds });
        }
    };
});
...
angular.module("cpLib").factory("ReviewFactory", function (ApiService) {
    return {
        ...
        getRecentReviews: function () {
            return ApiService.get("/reviews/recent-by-current-vendor");
        },
...
angular.module("cpLib").filter("messageLineBreakFormatter", function ($sce) {
    return function (message) {
        ...
        var formattedMessage = message.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "<br />");
